exports.default = {
   ...
   start: async (m, {
      ...
      if (User.checkUangUser(m.sender) <= 49) return m.reply(`Gagal Transfer Pastikan Uang Kamu Masih Mencukupi Minimal Transfer Uang Adalah 50 ketik .my untuk cek sisa uang`);      
