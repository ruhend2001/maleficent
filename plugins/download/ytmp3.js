exports.default = {
   ...
   start: async (m, {
      ...
      const audio = await Scraper.ocean(text, 'mp4', 144).catch(async () => await Scraper.ocean(text, 'mp4', 360)).catch(async () => await Scraper.ocean(text, 'mp4', 480)).catch(async () => await Scraper.ocean(text, 'mp4', 720)).catch(async () => await Scraper.ocean(text, 'mp4', 1080));     
