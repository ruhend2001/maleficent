...
// plugins status adalah model pesan pada file file plugins seperti model pesan limit seperti itu
...
// simple connections
const connections = async (conn) => {
   // Function koneksi tambahan bisa disini
   conn.sendContoh = async () => {
   // isi kode kamu
   }  
   // dan fungsi koneksi lainya
};
