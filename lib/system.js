...
const fake_wa = {
   key: {
      remoteJid: '6288807419898@s.whatsapp.net',
      fromMe: false,
   ...
   message: {
      extendedTextMessage: {
         ...
         previewType: 'NONE',
         contextInfo: {            
            mentionedJid: ["6288807419898@s.whatsapp.net"],
            remoteJid: "6288807419898@s.whatsapp.net",
...
exports.connections = (conn) => {
   ...
   conn.sendPrayer = (jid, time) => {
      const caption = `*Waktu ${time} Telah Tiba Silahkan Ambil Air Wudhu Dan Segera Laksanakan Sholat*\n` +
