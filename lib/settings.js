 ...
 * 
 * Cara ambil id nomor kamu mudah kok
 * 1. misalnya kalau ada grup yang kamu itu owner tapi bot kamu msh belum mendeteksi bahwa kamu bukan owner 
 * contoh lihat di gambar ini https://files.catbox.moe/r5q586.jpg
 * 2. kalian liat console ajah ada nama kalian dan di samping nya ada nomor id nah itu kalian salin atau copy atau catet ajh harus bener ya jangan salah atau kurang angka nya
 * contoh lihat id di gambar ini https://files.catbox.moe/ostumw.jpg
 * nah kalo udh di salin atau catet masukan di bagian owner number di config.json itu
 * 3. kalo udah berhasil kalian udah kedetek menjadi owner https://files.catbox.moe/2uf9p2.jpg
 * dan begitupun ambil id di nomor kamu lainnya
*/