/**
 * Script ini udh bener bener simple dan sangat mudah di gunakan 
 * Semua hanya menggunakan tipe module exports saja tidak menggunakan kode yg telalu riweh
 * Dan ga terlalu kebanyakan tetek bengek kaya kebanyakan new class constructor atau instance lainya sebenarnya bisa ya bisa ajh, cuma menggunakan tipe yg kodenya mudah saja
 * Jadi tinggal edit configurasi dan file plugin kalo mau nambah fitur, lalu plug and play saja
 * Dan yang terpenting udh di kasih penjelasannya juga kok
 * Jika di github update mulu terus terusan gtu pas di liat ya wajar buat fix bug dan perbaikan atau penambahan fitur kalo mau langsung tanpa git clone lagi ketik ajh .update
 * Script support vps atau panel butut minimal ram dan storage 512 MB (tergantung seringnya banyak user yg donlod)
 * Sebagian Fitur Button, List, Hydrated, SendGallery dan lain-lain, Mungkin Belum / Tak  Berfungsi Karna Baileys Original Whiskey Bukan Mod 
**/
const fs = require('fs');
...
global.link_group = 'https://chat.whatsapp.com/DVlfr6DILDBLePjyNtaYqN'
