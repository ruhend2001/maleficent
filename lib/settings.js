const fs = require('fs'); ({ Format: global.Format, Connect: global.Connect } = require('utils-mf')); global.setting = JSON.parse(fs.readFileSync('./config.json')), mess = JSON.parse(fs.readFileSync('./lib/message.json'));
...
global.link_group = 'https://chat.whatsapp.com/DCapY1JHFrgJYcChZSwUKe'
