...
const helper = async (m, {
   ...
   const type = Object?.keys(m?.message)[0], budy = typeof m.text == 'string' ? m.text : '', body = m.body;
   ...
   const mention = typeof (mentionByTag) == 'string' ? [mentionByTag] : mentionByTag; const command = m.command, prefix = m.prefix; 
