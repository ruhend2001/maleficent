...
let helper = async (m, { 
   ...
   let extra = {
conn, prefix, command, text, mime, args, cmd, Format, quoted, User, groupName, participants, groupAdmins, mentionUser, mentionByReply, group, budy, isAdmins, isOwner, isPremium, autodl
};
