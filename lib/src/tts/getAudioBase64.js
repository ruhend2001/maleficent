...
var getAudioBase64 = function(text, _a) {
   var _b = _a === void 0 ? {} : _a,
      _c = _b.lang,
      lang = _c === void 0 ? 'en' : _c,
      _d = _b.slow,
      slow = _d === void 0 ? false : _d,
      _e = _b.host,
      host = _e === void 0 ? 'https://translate.google.com' : _e,
      _f = _b.timeout,
      timeout = _f === void 0 ? 10000 : _f;
      ...
      return __generator(this, function(_h) {
         switch (_h.label) {
            case 0:
               ...
               shortTextList = splitLongText_1.default(text, {
                  splitPunct: splitPunct
               });
               return [4 /*yield*/ , Promise.all(shortTextList.map(function(shortText) {
                  return exports.getAudioBase64(shortText, {
                     lang: lang,
                     slow: slow,
                     host: host,
                     timeout: timeout
