...
module.exports = async (url, format, quality) => {
   try {
      const userAgentList = [
      ...
      const apiUrl = `https://p.oceansaver.in/ajax/download.php?copyright=0&format=${format == 'mp4' ? quality : 'mp3'}&url=${encodeURIComponent(url)}&api=dfcb6d76f2f6a9894gjkege8a4ab232222`;
