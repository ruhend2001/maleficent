...
const connect = async (m, {
   ...
   if (Object.keys(settings).length < 1) global.db.settings = { menu_type: 2, prefix: 'multi', cover: setting.thumbnail, status: 0, readsw: true, autobio: false, antispam: true, block_pc: false, auto_down: false, auto_sticker: false };
